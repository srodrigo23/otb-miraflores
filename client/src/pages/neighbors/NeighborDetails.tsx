  ...
  return (
    <div className='mx-auto container w-full flex flex-col gap-6 h-full py-7 px-3 lg:px-3'>
      ...
      <Card className="w-full shadow-sm">
        <CardBody>
          <div className="flex items-center gap-4 mb-6 pb-4 border-b border-blue-gray-50">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <Chip size="sm" value={data?.section || 'Sin sección'} color="blue" variant="ghost" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-4">
            ...
            <InfoField label="Fecha de Nacimiento" value={data?.birth_day ? new Date(data.birth_day).toLocaleDateString('es-ES') : '-'} />
